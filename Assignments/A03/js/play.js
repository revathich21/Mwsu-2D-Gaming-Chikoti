...
play.prototype = {
	create: function () {
		...
		platform_width = this.game.cache.getImage('obstacle1').width
	...
	spawnObstacle: function (entity, x, y, speed,has_given_point) {
		...
		//obstacle1.events.onOutOfBounds.add(this.killObstacle, this);
